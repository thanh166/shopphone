...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 15, 2022 lúc 02:03 AM
...
(150, 4, '2022-01-13 09:03:19', 'Nguyễn Huệ', '01207764668', 'Da Nang', '', 31340000, '1'),
(151, 9, '2022-01-13 09:04:39', 'Peanut ROX', '0833733599', 'Da Nang', 'Trực tiếp khi nhận h', 24340000, '1'),
(152, 4, '2022-01-13 09:50:43', 'Nguyễn Huệ', '01207764668', 'Da Nag', 'Trực tiếp khi nhận h', 5790000, '1'),
(153, 4, '2022-01-13 09:51:13', 'Nguyễn Huệ', '01207764668', 'VuDung', 'Qua thẻ ngân hàng', 7190000, '1'),
(154, 4, '2022-01-13 09:52:18', 'Nguyễn Huệ', '01207764668', 'VuDung', 'Trực tiếp khi nhận h', 7190000, '1'),
(155, 11, '2022-01-13 09:56:45', 'Vũ Dũng', '0833733599', 'Da Nang', 'Qua thẻ ngân hàng', 24340000, '1');
...
CREATE TABLE `nguoidung` (
  ...
  `session` varchar(100) CHARACTER SET utf8mb4 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(4, 'Nguyễn', 'Huệ', '', '01207764668', '', '', 'Hue', '1', 1, 1, ''),
(5, 'alo', 'Nam', 'alo', '0833445112', 'alo@gmail.com', 'alo', 'alo', 'c4ca4238a0b923820dcc509a6f75849b', 1, 1, ''),
(9, 'Peanut', 'ROX', '', '', 'leechristmas201@gmail.com', 'Da Nang', 'leechristmas201@gmail.com', '123', 1, 1, 'D2DDwzxACv'),
(10, 'Toản', 'Thái', '', '', 'thaitoanquangninh@gmail.com', 'Da Nang', 'thaitoanquangninh@gmail.com', '123', 1, 1, '7xzy02y99A'),
(11, 'Vũ', 'Dũng', '', '', 'nguyenvudung030121@gmail.com', 'Da Nang', 'nguyenvudung030121@gmail.com', '123', 1, 1, 'yD0x8w9wBB'),
(12, 'trực tuyến', 'Chủ phòng học', '', '', 'thcsxuanninh2021@gmail.com', 'Da Nang', 'thcsxuanninh2021@gmail.com', '123', 1, 1, 'x0Dy0CAvAD'),
(13, 'a', 'Nam', 'a', '5444888444', 'ad@gmail.com', '5444888444', 'as', 'c4ca4238a0b923820dcc509a6f75849b', 1, 1, '1');
...
--
ALTER TABLE `hoadon`
  MODIFY `MaHD` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=156;
...
--
ALTER TABLE `chitiethoadon`
  ADD CONSTRAINT `constraint_item` FOREIGN KEY (`MaSP`) REFERENCES `sanpham` (`MaSP`),
  ADD CONSTRAINT `foreignkey_MaHD` FOREIGN KEY (`MaHD`) REFERENCES `hoadon` (`MaHD`);
