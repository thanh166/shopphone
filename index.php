...
<head>
	...
	<?php require_once('core/controller.Class.php'); ?>
</head>

<body>

<?php if(isset($_COOKIE['MaND']) && isset($_COOKIE['sess'])){
            $Controller = new Controller();
            if($Controller -> checkUserStatus($_COOKIE['MaND'], $_COOKIE['sess'])){
                echo $Controller -> login(intval($_COOKIE['MaND']));
            }
